...
//	self
	...
	public void testRow015() throws Exception {
		...
		Optional<TestIntermediateAnalysisResult> rotten1OP = tc.stream()
...
//]
	...
	public void testRow016() throws Exception {
		...
		List<TestIntermediateAnalysisResult> rottens = tc.stream()
...
//now check the second test
	...
	public void testRow21() throws Exception {
		...
		TestIntermediateAnalysisResult rottenTest0 = etEn.processSingleTest(dynInf,
				"RottenTestsFinder.FakePaperTests.RTFRow21", "testPrimeNumberChecker");
		...
		TestIntermediateAnalysisResult rottenTest2 = etEn.processSingleTest(dynInf,
				"RottenTestsFinder.FakePaperTests.RTFRow21", "testPrimeNumberChecker2");
	...
	public void testRTFRow25Exception2() throws Exception {
		...
		// Second test
		Optional<TestIntermediateAnalysisResult> rotten0 = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test0")).findFirst();
		...
		// Second test
		Optional<TestIntermediateAnalysisResult> rotten1 = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test1")).findFirst();
		...
		// Second test
		Optional<TestIntermediateAnalysisResult> rotten2 = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test2")).findFirst();
	...
	public void testRTFRow27HelperDistance() throws Exception {
		...
		Optional<TestIntermediateAnalysisResult> rotten0P = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test0")).findFirst();
		...
		Optional<TestIntermediateAnalysisResult> rotten1P = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test1")).findFirst();
		...
		Optional<TestIntermediateAnalysisResult> rotten3P = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test3")).findFirst();
		...
		Optional<TestIntermediateAnalysisResult> rotten4P = tc.stream()
				.filter(e -> e.getTestMethodFromClass().equals("test4")).findFirst();
	...
	public void testRTFRow30Skip() throws Exception {
		...
		// This include all skips from static
		assertTrue(rottenTest0.getAllSkipFromTest().size() > 0);
		...
		/// Assert
		TestIntermediateAnalysisResult rottenTest3 = etEn.processSingleTest(dynInf,
				"RottenTestsFinder.FakePaperTests.RTFRow30Skip", "test3");
